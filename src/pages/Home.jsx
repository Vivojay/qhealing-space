...
const SERVICES = [
  ...
  { name: 'Akashic Records', desc: 'Access the vibrational archive of your soul\'s entire journey — past, present, and future.' },
  { name: 'Deep Chakra Healing', desc: 'Balance your 7 energy centers to transform physical, emotional, and spiritual wellbeing.' },
  { name: 'Past Life Regression', desc: 'Uncover karmic roots behind present-day patterns, fears, and chronic conditions.' },
  { name: 'Angel Therapy', desc: 'Connect with archangels and guardian angels for guidance across all areas of life.' },
  { name: 'Sound Therapy', desc: 'Tibetan bowls, gongs, and tuning forks create resonance fields for cellular healing.' },
];

const TESTIMONIALS = [
  {
    quote: "After just three sessions of Chakra Healing with Vartika, a 12-year chronic back pain I had been carrying simply dissolved. I didn't believe it was possible — and yet here I am.",
    name: 'Priya Mehta',
    role: 'Architect, Delhi',
  },
  {
    quote: "The Past Life Regression session explained patterns in my relationships I had never understood. It was like seeing the code beneath the program of my life. Profoundly healing.",
    name: 'Rohit Sharma',
    role: 'Entrepreneur, Mumbai',
  },
  {
    quote: "Vartika's corporate workshop on stress management completely shifted our team's dynamic. People were calmer, more present, and surprisingly — more productive. Remarkable work.",
    name: 'Sunita Agarwal',
  ...
  return (
    <div style={{ background: 'var(--bg)' }}>
      ...
      <section ref={heroRef} className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-0" style={{ background: 'linear-gradient(to right, var(--bg) 25%, rgba(12,10,9,0.6) 55%, rgba(12,10,9,0.2) 100%)' }} />
        <div className="absolute inset-0" style={{ background: 'linear-gradient(to top, var(--bg) 0%, transparent 35%)' }} />
        ...
        <div className="absolute inset-0 flex flex-col justify-between px-8 lg:px-14 py-10 lg:py-12 pointer-events-none">
          ...
          <div className="max-w-sm pointer-events-auto">
            ...
            <motion.p
              ...
              style={{ color: 'var(--fg2)' }}
            >
              Ancient wisdom, sacred ritual, and transformative practice — converging for your healing and spiritual growth.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 16 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        {/* ── QUANTUM HEALING SPACE — Vertical large text (right side) ── */}
        <div className="absolute right-0 top-0 h-full flex flex-col justify-center overflow-hidden pointer-events-none select-none"
          style={{ width: '55%', paddingRight: 0 }}>
          {['QUANTUM', 'HEALING', 'SPACE'].map((word, i) => (
            <motion.span
              key={word}
              initial={{ opacity: 0, x: 50 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 1.4, delay: 0.3 + i * 0.18, ease: [0.22, 1, 0.36, 1] }}
              className="block text-right leading-[0.88] tracking-tighter translate-x-[6%]"
              style={{
                fontSize: 'clamp(4.5rem, 17vw, 19rem)',
                fontFamily: 'Space Grotesk, sans-serif',
                fontWeight: 300,
                color: 'rgba(250,250,249,0.08)',
                WebkitTextStroke: '1px rgba(250,250,249,0.15)',
              }}
            >
              {word}
            </motion.span>
      ...
      {/* ═══ MANIFESTO with overlapping boxes ═══ */}
      <section className="relative py-32 lg:py-44 overflow-hidden" style={{ background: 'var(--bg)' }}>
        {/* Decorative offset rectangle */}
        <div
          className="absolute top-16 left-[15%] w-[65%] h-[75%] pointer-events-none"
        ...
        <div className="max-w-6xl mx-auto px-8 lg:px-16 relative">
          ...
          {/* Main quote — large serif */}
          <motion.blockquote
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 1.1, ease: [0.22, 1, 0.36, 1] }}
            className="font-display text-4xl lg:text-6xl leading-tight mb-0 relative z-10"
            style={{
          ...
          >
            All conditions are treatable through<br />
            <span style={{ color: 'var(--fg2)' }}>SPIRITUAL HEALING</span> — though not all
            <br className="hidden lg:block" /> people are equally receptive.
          </motion.blockquote>

          {/* Overlapping card — bleeds over the rectangle boundary */}
          <motion.div
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.9, delay: 0.3, ease: [0.22, 1, 0.36, 1] }}
            className="relative z-20 mt-[-1rem] lg:mt-[-2rem] ml-auto w-full lg:w-2/3 p-8 lg:p-12"
            style={{ background: 'var(--bg2)', border: '1px solid var(--border)' }}
          >
            <p className="text-[14px] font-light leading-relaxed mb-6" style={{ color: 'var(--fg2)' }}>
              Healing works best when approached with faith and openness. Results vary, yet it is extremely rare for someone to receive healing and experience no improvement. Many feel profound shifts even where conventional treatments could not reach.
            </p>
            <div className="flex items-center gap-4">
      ...
      {/* ═══ SERVICES PREVIEW ═══ */}
      <section className="py-24 lg:py-36" style={{ borderTop: '1px solid var(--border)', background: 'var(--bg)' }}>
        <div className="max-w-7xl mx-auto px-8 lg:px-16">
          <div className="flex items-end justify-between mb-16">
            <div>
              ...
              >
                20+ Pathways
                <br /><span style={{ color: 'var(--fg2)', fontStyle: 'italic' }}>to Wholeness</span>
              </motion.h2>
            </div>
            <motion.div
              initial={{ opacity: 0 }}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px" style={{ background: 'var(--border)' }}>
            {SERVICES.map((s, i) => (
              <motion.div
                ...
                className="group p-8 lg:p-10 cursor-pointer"
                style={{ background: 'var(--bg)' }}
                whileHover={{ backgroundColor: 'var(--bg2)' }}
              >
                <span className="text-[10px] font-mono mb-5 block" style={{ color: 'var(--fg3)' }}>
      ...
      <section className="py-24 lg:py-36" style={{ borderTop: '1px solid var(--border)', background: 'var(--bg)' }}>
        <div className="max-w-7xl mx-auto px-8 lg:px-16">
          <motion.div
            ...
            className="mb-16"
          >
            <p className="text-[10px] tracking-[0.45em] uppercase mb-4" style={{ color: 'var(--fg3)' }}>
              Voices
            </p>
            <h2
              className="text-4xl lg:text-5xl"
          ...
          <div className="grid md:grid-cols-3 gap-px" style={{ background: 'var(--border)' }}>
            {TESTIMONIALS.map((t, i) => (
              ...
              >
                {/* Large quote mark */}
                <div
                  className="text-7xl leading-none mb-6 font-display"
                  style={{ fontFamily: 'Cormorant Garamond, serif', color: 'var(--fg3)', lineHeight: 1 }}
                >
                  "
                </div>
                <p
      ...
      <section className="py-24 lg:py-32 relative overflow-hidden" style={{ borderTop: '1px solid var(--border)' }}>
        <div className="max-w-7xl mx-auto px-8 lg:px-16 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-12">
          <div>
            ...
            >
              Ready to go deeper
              <br /><em style={{ color: 'var(--fg2)' }}>into yourself?</em>
            </motion.h2>
          </div>
          <motion.div
            initial={{ opacity: 0 }}
